						...
						post : function($scope, $element, $attrs, controller) {
							promise.then(function() {
								...
								function parseViewValue(value) {
									...
									// get view values capped used on view
								...
								// $evalAsync from a directive it should run after the DOM has been manipulated
								// by Angular but before the browser renders
								if (options.value) {
